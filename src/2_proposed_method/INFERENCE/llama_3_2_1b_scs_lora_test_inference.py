# Inference-only: llama_3_2_1b_scs_lora (test)
...
BACKBONE_MODEL = 'HTThuanHcmus/llama-3.2-1b-merge'
TOKENIZER_MODEL = 'HTThuanHcmus/llama-3.2-1b-Thuan'
MODEL_FAMILY = 'llama'
VARIANT_NAME = 'llama_3_2_1b_scs_lora'
ADAPTER_FILENAME = 'llama_3_2_1b_scs_lora_best_adapter.pt'
TRAINING_PROMPT_MODE = 'type_aware'
CASCADED_INPUT_SCALE = 1.0
EXPECTED_INJECTED_MODULES = 64

# Inference-only: qwen3_0_6b_scs_lora (test)
...
BACKBONE_MODEL = 'HTThuanHcmus/qwen3-0.6b-merge'
TOKENIZER_MODEL = 'HTThuanHcmus/qwen3-0.6b-merge'
MODEL_FAMILY = 'qwen'
VARIANT_NAME = 'qwen3_0_6b_scs_lora'
ADAPTER_FILENAME = 'qwen3_0_6b_scs_lora_best_adapter.pt'
